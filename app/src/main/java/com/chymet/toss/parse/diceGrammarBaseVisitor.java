...
/**
 * This class provides an empty implementation of {@link diceGrammarVisitor},
 ...
 */
public class diceGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements diceGrammarVisitor<T> {
	/**
	 * {@inheritDoc}
	 * <p/>
	 ...
	 * {@link #visitChildren} on {@code ctx}.
	 */
	@Override public T visitExpr(@NotNull diceGrammarParser.ExprContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.
	 */
	@Override public T visitEmpty(@NotNull diceGrammarParser.EmptyContext ctx) { return visitChildren(ctx); }
}